import {ETHER_NETWORK_NAME, MAGIC_KEY, ZK_API_BASE} from "@/plugins/build";
import {EthNetworkName} from "@magic-sdk/types/dist/es/modules/rpc-provider-types";
...
export const mutations = mutationTree(state, {
  ...
  setOnboard(state: WalletModuleState, obj: unknown): void {
    state.onboard = obj;
  },
...
export const actions = actionTree(
  { state, getters, mutations },
  {
     ...
     */
    onboardInit({ state, commit }): void {


      const magic = new Magic(MAGIC_KEY, {
        network: ETHER_NETWORK_NAME.toLowerCase() as EthNetworkName
      });
      // @ts-ignore
