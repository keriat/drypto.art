        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-6">
              ...
              <h1 class="wow fadeInUp" data-wow-delay=".5s">Drypto.art</h1>
              <h6 class="wow fadeInUp" data-wow-delay=".5s"><span class="text-uppercase id-color-2">Create, digitize, collect or sell digital masterpieces.</span></h6>
              <div class="spacer-20"></div>
              <h3 class="wow fadeInUp" data-wow-delay=".75s">Are you a galleriest? An artist? Art consultant?</h3>
              <p class="wow fadeInUp lead" data-wow-delay="1s">
                Join the Drypto to build your digital collection of the masterpieces to show, expo and sell.<br>Drypto is build as a place to shape the masterpiece for eternity
              </p>
              <div class="spacer-10"></div>
              <nuxt-link to="/explore" class="btn-main wow fadeInUp lead" data-wow-delay="1.25s">Explore</nuxt-link>
              <div class="mb-sm-30"></div>
            </div>
            <div class="col-md-6 xs-hide">
              <img src="@/assets/images/misc/nft.png" class="lazy img-fluid wow fadeIn" data-wow-delay="1.25s" alt="">
            </div>
          </div>
        </div>
      </div>
